...
namespace Grupirovki
{
    public class Zona
    {
        ...
        public Zona(int id,int id_capture, UnityEngine.GameObject gm, string name,int type,int addition_var_resource,int addition_export_resource,int max_suqads,int[] id_of_suqads,int squads_in)
        {
            Id = id;
